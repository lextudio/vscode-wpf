...
export interface WpfPropertyGridEntry {
  readonly typeName: string;
...
export interface WpfToolboxUiController {
  updatePropertyGrid(entry: WpfPropertyGridEntry): void;
  clearPropertyGrid(message?: string): void;
}
